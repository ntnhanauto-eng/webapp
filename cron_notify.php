...
if ($mode === 'check_dismissal') {
    ...
    // Kiểm tra trước giờ tan học sáng 60 phút (cho phép sai số ±10 phút do cron chạy mỗi 15 phút)
    ...
    // Kiểm tra trước giờ tan học chiều 60 phút
...
elseif ($mode === 'evening') {
    ...
    echo "Đã kết nối thành công! Vui lòng thêm tham số ?type=check_dismissal hoặc ?type=evening trên URL để chạy tính năng tương ứng.";
}
?>
